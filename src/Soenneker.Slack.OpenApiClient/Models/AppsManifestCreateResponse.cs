...
namespace Soenneker.Slack.OpenApiClient.Models
{
    ...
    public partial class AppsManifestCreateResponse : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Slack.OpenApiClient.Models.Credentials? Credentials { get; set; }
#nullable restore
#else
        public global::Soenneker.Slack.OpenApiClient.Models.Credentials Credentials { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Slack.OpenApiClient.Models.Error2>? Errors { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Slack.OpenApiClient.Models.Error2> Errors { get; set; }
#endif
...
#nullable restore
        ...
        public string Needed { get; set; }
#endif
        /// <summary>The oauth_authorize_url property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public static global::Soenneker.Slack.OpenApiClient.Models.AppsManifestCreateResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Slack.OpenApiClient.Models.AppsManifestCreateResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "credentials", n => { Credentials = n.GetObjectValue<global::Soenneker.Slack.OpenApiClient.Models.Credentials>(global::Soenneker.Slack.OpenApiClient.Models.Credentials.CreateFromDiscriminatorValue); } },
                { "error", n => { Error = n.GetStringValue(); } },
                { "errors", n => { Errors = n.GetCollectionOfObjectValues<global::Soenneker.Slack.OpenApiClient.Models.Error2>(global::Soenneker.Slack.OpenApiClient.Models.Error2.CreateFromDiscriminatorValue)?.AsList(); } },
                { "needed", n => { Needed = n.GetStringValue(); } },
                { "oauth_authorize_url", n => { OauthAuthorizeUrl = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Slack.OpenApiClient.Models.Credentials>("credentials", Credentials);
            writer.WriteStringValue("error", Error);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Slack.OpenApiClient.Models.Error2>("errors", Errors);
            writer.WriteStringValue("needed", Needed);
            writer.WriteStringValue("oauth_authorize_url", OauthAuthorizeUrl);
