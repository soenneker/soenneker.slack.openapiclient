...
namespace Soenneker.Slack.OpenApiClient.Models
{
    ...
    public partial class ChatPostMessageResponse : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string Channel { get; set; }
#endif
        /// <summary>The deprecated_argument property</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public string? DeprecatedArgument { get; set; }
#nullable restore
#else
        public string DeprecatedArgument { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Slack.OpenApiClient.Models.ChatPostMessageResponseMessage? Message { get; set; }
#nullable restore
#else
        public global::Soenneker.Slack.OpenApiClient.Models.ChatPostMessageResponseMessage Message { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Slack.OpenApiClient.Models.ChatPostMessageResponse"/> and sets the default values.
        /// </summary>
        ...
        public static global::Soenneker.Slack.OpenApiClient.Models.ChatPostMessageResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Slack.OpenApiClient.Models.ChatPostMessageResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "deprecated_argument", n => { DeprecatedArgument = n.GetStringValue(); } },
                { "error", n => { Error = n.GetStringValue(); } },
                { "errors", n => { Errors = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "message", n => { Message = n.GetObjectValue<global::Soenneker.Slack.OpenApiClient.Models.ChatPostMessageResponseMessage>(global::Soenneker.Slack.OpenApiClient.Models.ChatPostMessageResponseMessage.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteStringValue("deprecated_argument", DeprecatedArgument);
            writer.WriteStringValue("error", Error);
            writer.WriteCollectionOfPrimitiveValues<string>("errors", Errors);
            writer.WriteObjectValue<global::Soenneker.Slack.OpenApiClient.Models.ChatPostMessageResponseMessage>("message", Message);
